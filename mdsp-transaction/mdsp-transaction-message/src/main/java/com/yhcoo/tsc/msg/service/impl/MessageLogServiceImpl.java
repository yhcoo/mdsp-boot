package com.yhcoo.tsc.msg.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.yhcoo.common.exception.MessageExceptionEnum;
import com.yhcoo.common.exception.MdspException;
import com.yhcoo.tsc.msg.common.*;
import com.yhcoo.tsc.msg.common.IOCUtil;
import com.yhcoo.tsc.msg.common.PublicEnum;
import com.yhcoo.tsc.msg.dto.EventTypeEnum;
import com.yhcoo.tsc.msg.mapper.MessageLogMapper;
import com.yhcoo.tsc.msg.pojo.MessageLog;
import com.yhcoo.tsc.msg.service.IMessageEventHandler;
import com.yhcoo.tsc.msg.service.IMessageLogService;
import com.yhcoo.tsc.msg.common.MessageStatusEnum;
...
public class MessageLogServiceImpl extends ServiceImpl<MessageLogMapper, MessageLog>
    ...
    private void checkEmptyMessage(MessageLog messageLog) {
        ...
        if (StringUtils.isEmpty(messageLog.getMessageId())) {
            throw new MdspException(MessageExceptionEnum.MESSAGE_ID_CANT_EMPTY);
        }
        if (StringUtils.isEmpty(messageLog.getMessageBody())) {
            throw new MdspException(MessageExceptionEnum.MESSAGE_BODY_CANT_EMPTY);
        }
//        if (StringUtils.isEmpty(messageLog.getConsumerQueue())) {
//            throw new MdspException(MessageExceptionEnum.QUEUE_CANT_EMPTY);
//        }
    }
