package com.yhcoo.gateway.config;


import com.yhcoo.common.config.IgnoreUrlPropertiesConfig;
import com.yhcoo.gateway.auth.endpoint.AuthExceptionEntryPoint;
import com.yhcoo.gateway.auth.handler.CustomAccessDeniedHandler;
