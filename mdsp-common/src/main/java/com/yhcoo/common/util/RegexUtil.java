...
//        System.out.println("邮政编码验证: "+RegexUtil.isZipCode("162406"));
        System.out.println("身份证号码验证: "+RegexUtil.isIdCardNo("460024301007162"));
//        System.out.println("手机号码验证: "+RegexUtil.isMobile("18757569277"));
...
//        System.out.println(NumberUtils.toInt("-0000000002"));
    ...
    public final static boolean isPwd(String str) {
        return match(str, "^(?![a-zA-z]+$)(?!\\d+$)(?![!@#$%^&*]+$)[a-zA-Z\\d!@#$%^&*]+$");
    }
    ...
    public final static boolean isTel(String text){
        if(isMobile(text)||isMobile(text)) return true;
        return false;
    }
    ...
    public final static boolean isIdCardNo(String text){
        ...
        return match(text, regularExpression);
    }
